...
<body id="body-pd">
   ...
   $reponse=$conn->query($req);
    ...
    echo "<tr><th>id_de_sortie</th><th>id_de_preduit</th><th>id_de_user</th><th>id_de_client</th><th>quantité</th><th>date_de_sortie</th></tr>";
	 ...
	 echo "<tr>";
     echo "<td>";
	 echo $user['id_de_sortie']."</td><td>".$user['id_de_preduit']."</td><td>".$user['id_de_user']."</td><td>".$user['id_de_client']."</td><td>".$user['quantité']."</td><td>".$user['date_de_sortie']."</td>";
	  ?>
...
function confirmer(v){
    ...
    if(res){
        ...
        window.location.href="supprimer/supprimer_sortie.php?id="+v+'';
