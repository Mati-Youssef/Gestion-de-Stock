...
if (isset($valider)){
   ...
   $conn->exec($req1);
   header("location:../modifier/lister_client.php");
 }
...
<form method="post" action="" class="needs-validation" style=" margin:180px 20%" novalidate>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" value=" <?php echo $user[1]; ?> " class="form-control" name="année" placeholder="l'année ?" value="" required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" value=" <?php echo $user[2]; ?> " class="form-control" name="Mois" placeholder="Mois ?" value="" required>
      <div class="valid-tooltip">
        Looks good!
      </div>
    </div>
    <div class="col-md-4 mb-3">
      ...
      <input type="text" value=" <?php echo $user[3]; ?> " class="form-control" name="idproduit" placeholder="Entre id.." value="" required>
