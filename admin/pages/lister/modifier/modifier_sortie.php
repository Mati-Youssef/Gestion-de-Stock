...
<?php 
 ...
 $req2="SELECT * FROM sortie WHERE id_de_sortie =\"$v\"";
...
<form method="post" action="">
  ...
  <div class="form-row">
    <?php 
     ...
     <div class="col-md-4 mb-3">
      ...
      <input type="text"  value=" <?php echo $user[1]; ?> " name="id_de_preduit" class="form-control" id="validationServer01" placeholder="ID de produit" value="" required>
     ...
     <div class="col-md-4 mb-3">
      ...
      <input type="text"  value=" <?php echo $user[2]; ?> " name="id_de_user" class="form-control" id="validationServer01" placeholder="ID de user" value="" required>
      
     </div>
     <div class="col-md-4 mb-3">
      
      <label for="validationServer03">quantité</label>
      <input type="text"   value=" <?php echo $user[5]; ?> " class="form-control" name="quantité"  id="validationServer03" placeholder="quantité"  required>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text"  value=" <?php echo $user[3]; ?> " name="id_de_client" class="form-control" id="validationServer01" placeholder="Nom de preduit" value="" required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="date" name="date_de_sortie" class="form-control" value=" <?php echo $user[6]; ?> " id="validationServer02" placeholder="date de sortie"  required>
     </div>
     ...
     <label for="validationServer04">Prix de sortie</label>
      ...
      <input type="text"  value=" <?php echo $user[4]; ?> " name="Prix" class="form-control" id="validationServer04" placeholder="Prix" required> 
    </div>
   </div>
  </div>
  <div class="form-row">
