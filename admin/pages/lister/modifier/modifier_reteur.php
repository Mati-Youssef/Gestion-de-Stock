...
<?php
 ...
 $req1="UPDATE reteur SET date_reteur=\"$dreteur\",id_client=\"$idclient\",id_produit=\"$idproduit\",quantité=\"$quantité\" WHERE id_reteur =\"$v\"";
if (isset($valider)){
...
$req2="SELECT * FROM reteur WHERE id_reteur =\"$v\"";
...
<form method="post" action="" class="needs-validation" style=" margin:180px 20%" novalidate>
  <fieldset>
     <?php 
         ...
         ?>
  <h3>Espace de Roteor :</h3> <br>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationTooltip01">Date de Rotour :</label>
      <input type="Date" value=" <?php echo $user[0]; ?> " class="form-control" name="dreteur" placeholder="Date de Routeur ?" value="" required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" value=" <?php echo $user[1]; ?> " class="form-control" name="idclient" placeholder="Entre id .." value="" required>
      <div class="valid-tooltip">
        Looks good!
      </div>
    </div>
